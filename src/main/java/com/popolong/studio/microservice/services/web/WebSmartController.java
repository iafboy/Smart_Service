...
import com.popolong.studio.microservice.services.web.webmodel.Account;
...
@Controller
public class WebSmartController {

	@Autowired
	protected WebSmartService accountsService;

	protected Logger logger = Logger.getLogger(WebSmartController.class
			.getName());

	public WebSmartController(WebSmartService accountsService) {
	...
	@RequestMapping("/smartSerivces/owner/{text}")
	public String ownerSearch(Model model, @PathVariable("text") String name) {
		...
		if (accounts != null)
			model.addAttribute("smartSerivces", accounts);
		return "smartSerivces";
	}

	@RequestMapping(value = "/smartSerivces/search", method = RequestMethod.GET)
	public String searchForm(Model model) {
		model.addAttribute("searchCriteria", new SearchCriteria());
		return "accountSearch";
	}

	@RequestMapping(value = "/smartSerivces/dosearch")
